...
class HybridLinkListRepFactory : public MemTableRepFactory {
 public:
  explicit HybridLinkListRepFactory(uint32_t threshold_use_skiplist,
  ...
  virtual ~HybridLinkListRepFactory() {}
  ...
  virtual const char* Name() const override {
    return "HybridLinkListRepFactory";
  }
