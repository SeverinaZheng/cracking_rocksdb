...
static enum RepFactory StringToRepFactory(const char* ctype) {
  ...
  else if (!strcasecmp(ctype, "adaptive_linkedlist"))
    return kAdaptiveLinkedList;
  else if (!strcasecmp(ctype, "hybrid_linkedlist"))
    return kHybridLinkedList;
  ...
  void PrintHeader() {
    ...
    switch (FLAGS_rep_factory) {
      ...
      case kHashLinkedList:
        ...
        break;
      case kAdaptiveLinkedList:
        fprintf(stdout, "Memtablerep: adaptive_linkedlist\n");
        break;
      case kHybridLinkedList:
        fprintf(stdout, "Memtablerep: hybrid_linkedlist\n");
        break;
    }
  ...
  void Run() {
    ...
    while (std::getline(benchmark_stream, name, ',')) {
      ...
      if (name == "fillseqdeterministic" ||
        ...
        fprintf(stdout, "This is YCSBWorkloadA\n");
        method = &Benchmark::YCSBWorkloadA;
      } else if (name == "ycsbwkldb") {
        fprintf(stdout, "This is YCSBWorkloadB\n");
  ...
  void InitializeOptionsFromFlags(Options* opts) {
    ...
    switch (FLAGS_rep_factory) {
      ...
      case kVectorRep:
        ...
        break;
      case kAdaptiveLinkedList:
        options.memtable_factory.reset(NewAdaptiveLinkListRepFactory(0,1,false));
        break;
      case kHybridLinkedList:
        options.memtable_factory.reset(NewHybridLinkListRepFactory(0,1,false,1000));
        break;
